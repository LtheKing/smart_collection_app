...
<h1>Data Deskcoll</h1>
<a href="" class="btn btn-info mb-3" id="btn_create">Deskcoll Baru</a>
...
<div id="id01" class="modal">
    ...
    <form class="modal-content" action="/action_page.php">
      <div class="container">
        <h1>Hapus Data Deskcoll</h1>
        <p>Anda Yakin Menghapus Data Deskcoll ini ?</p>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $('#table_Deskcoll tbody').on( 'click', 'button', function () {
                ...
                {
                    window.location.href = localhost + 'Deskcoll/edit/' + data.id;
                }
                ...
                if(action.includes('btnDelete'))
                {
                    ...
                    $('#btnYes').on('click', function() {
                        ...
                        alert('Data Deskcoll Berhasil Dihapus');
                    })
                }

                if(action.includes('btnDetail'))
                {
                    window.location.href = localhost + 'Deskcoll/detail/' + data.id;
                }                
            });
        });
        ...
        {   
            ...
            const response = await fetch(localhost + "api/Deskcoll/delete/" + id, {
                method: 'DELETE',
                headers: {
